...
import { SmallSpamButton } from "./mybutton.jsx";
...
export const AdminSpamReport = (props) => {
    ...
    return (
        <>
            <div className="h-auto max-w-full" onClick={() => document.getElementById(modalId).showModal()}>
                <motion.div
                                            ...
                                            <button
                                                ...
                                                Gemini AI
                                                {
                                                    props.isSummaried === true ? <div>
                                                        <ThreeDots height="10" width="26" radius="6" color="#ffffff"
