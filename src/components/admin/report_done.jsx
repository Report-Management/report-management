...
import { CompletedButton, SmallCompletedButton} from "./mybutton.jsx";
                        ...
                        <div>
                            <div className="flex flex-row justify-between">
                                <div className="flex justify-start items-center space-x-3 w-full" onClick={() => document.getElementById(modalId).showModal()}>
                                    {props.profile ?
                                        <Avatar alt="User settings object-cover" img={props.profile} rounded/> : <Avatar
                                            alt="User settings"
                                            size="xs"
                                ...
                                <div className="text-white rounded-lg text-sm md:text-md font-semibold flex">
                                    {
                                        props.isLoading ? <span className="loading loading-spinner text-primary"></span> : <SmallCompletedButton  completed={props.completed} onCompleted={props.onCompleted} />
                                    }
                                </div>
                            </div>
                        </div>
            ...
            <dialog key={props.id} id={modalId} className="modal">
                <div className="modal-box max-w-[50%] w-full" style={{
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <div className="text-white rounded-lg text-sm md:text-md font-semibold flex">
                            {
                                props.isLoading ? <span className="loading loading-spinner text-primary"></span> : <CompletedButton  completed={props.completed} onCompleted={props.onCompleted} />
                            }
                        </div>
                    </div>
                    <div className="pt-3">
